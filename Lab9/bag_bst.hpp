...
//  Lab9
//
//  Created by Liying Liang  on 3/8/19.
...
#include "bintree.hpp"   // Provides binary_tree_node and related functions
...
#pragma mark - Toolkit Function Implementation
    ...
    // function returns false).
    {
        ...
        // STUDENT WORK
        bst_remove_max(root_ptr->left(), root_ptr->data()); //confused
...
#pragma mark - Member Function Implementation
    ...
    {
        // STUDENT WORK
        root_ptr=tree_copy(source.root_ptr);  //use tree copy to copy all the node 
    }
    ...
    // Header file used: bintree.h
    {
        ...
        do
        {
            ...
            {   // Go left
                ...
                // STUDENT WORK
                //if reaches the lowest left subtree
                if(cursor->left()==NULL){
                    cursor->left()=new binary_tree_node<Item>(entry);
                    done=true;
                }
                else{
                    //curse to left if not found
                    cursor=cursor->left();
                }
            ...
            {   // Go right
                ...
                // STUDENT WORK
                //if reaches the lowest right subtree
                if (cursor->right()==NULL){
                    cursor->right()=new binary_tree_node<Item>(entry);
                    done=true;
                }
                else{
                    //curse to right if not found
                    cursor=cursor->right();
                }
    ...
    // method.
    {
        ...
        {
            // STUDENT WORK
            insert(addroot_ptr->data()); //add first node as root
