...
//  Lab8
//
//  Created by Liying Liang  on 3/1/19.
...
#include "deque_iterator.hpp" // The iterator class for deque (refer to file deque_iterator.h)
...
namespace coen79_lab8
{
    ...
    void deque<Item>::operator=(const deque<Item>& source) {
        ...
        // STUDENT WORK...
        block_pointers=new value_type*[bp_array_size];
        block_pointers_end=block_pointers+(bp_array_size-1); //make the block_pointers_end pointing to the end of the array
        ...
        for (size_type bp_array_index = 0; bp_array_index < source.bp_array_size; ++bp_array_index)
        {
            ...
            else
            {
                ...
                {
                    // STUDENT WORK...
                    //if front_pointer is encountered
                    ...
                    //if back_pointer is encountered
    ...
    deque<Item>::~deque () {
        ...
        // STUDENT WORK...
//        for(size_type bp_array_index=0; bp_array_index<block_size; ++bp_array_index){
